...
const CURATED = [
  ...
  { b: [-90, 0, -270, -180], roads: false },    // Part 33: SW-central cluster (rides the generic roads)
  { b: [-90, 0, 450, 540], roads: false },      // Part 34: N-far cluster (rides the generic roads)
  { b: [180, 270, 450, 540], roads: false },    // Part 35: NE-edge cluster (rides the generic roads)
  { b: [180, 270, 0, 90], roads: false },       // Part 36: E-central2 cluster (rides the generic roads)
  { b: [90, 180, 360, 450], roads: false },     // Part 37: N-central2 cluster (rides the generic roads)
  { b: [90, 180, 450, 540], roads: false },     // Part 38: N-edge cluster (rides the generic roads)
  { b: [180, 270, -360, -270], roads: false },  // Part 39: SE-central2 cluster (rides the generic roads)
  { b: [270, 360, -270, -180], roads: false },  // Part 40: E-central3 cluster (rides the generic roads)
  { b: [-180, -90, -540, -450], roads: false }, // Part 41: SW-far2 cluster (rides the generic roads)
  { b: [-270, -180, 450, 540], roads: false },  // Part 42: NW-edge cluster (rides the generic roads)
  { b: [0, 90, -270, -180], roads: false },     // Part 43: S-central2 cluster (rides the generic roads)
  { b: [-270, -180, -270, -180], roads: false },// Part 44: W-central cluster (rides the generic roads)
  { b: [-180, -90, -180, -90], roads: false },  // Part 45: W-central2 cluster (rides the generic roads)
  { b: [90, 180, 90, 180], roads: false },      // Part 46: central cluster (rides the generic roads)
